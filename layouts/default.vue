<template>
  <header>
    <nav class="navbar">
      <div>
        <p class="font-bold text-2xl">Paragon Academy</p>
      </div>
      <!-- <div>
        <div>Search</div>
      </div> -->
  ...
  <footer class="px-[10%] bg-[#F0F7FF] py-[4rem]">
    <dvi class="grid grid-cols-3">
      <div class="font-bold text-3xl text-center">Paragon Academy</div>
      <div class="grid grid-cols-3 col-span-2">
        <p class="py-3 font-semibold">Udemy Business</p>
        <p class="py-3 font-semibold">Udemy Business</p>
        <p class="py-3 font-semibold">Udemy Business</p>
        <p class="py-3 font-semibold">Udemy Business</p>
        <p class="py-3 font-semibold">Udemy Business</p>
    ...
    <div class="text-center pt-[6rem]">
      <p>By creating an account, you agree to Terms & Conditions and Privacy Policy</p>
    </div>
  </footer>
</template>
